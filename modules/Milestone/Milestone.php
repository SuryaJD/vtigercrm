...
class Milestone extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_milestone';
	var $table_index= 'milestoneid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_milestonecf', 'milestoneid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_milestone', 'vtiger_milestonecf');
	...
	var $related_tables = Array( 
					'vtiger_milestonecf' => Array('milestoneid')
					);
	...
	var $tab_name_index = Array(
		...
		'vtiger_milestone'   => 'milestoneid',
	    'vtiger_milestonecf' => 'milestoneid');
	...
	var $list_fields = Array (
		...
		'Milestone No' => Array('milestone', 'milestoneno'),
/*'Milestone No'=> Array('milestone', 'milestoneno'),*/
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'Milestone No' => 'milestoneno',
/*'Milestone No'=> 'milestoneno',*/
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view
	var $list_link_field = 'milestoneno';
...
/*'Milestone No'=> 'milestoneno',*/
	...
	var $popup_fields = Array ('milestoneno');

	// For Alphabetical search
	var $def_basicsearch_col = 'milestoneno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'milestoneno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('milestoneno','assigned_user_id');

	var $default_order_by = 'milestoneno';
	...
	*/
	function vtlib_handler($moduleName, $eventType) {
		global $adb;
 		if($eventType == 'module.postinstall') {
			...
			Milestone::checkWebServiceEntry();
			Milestone::createUserFieldTable($moduleName);
			Milestone::addInTabMenu($moduleName);
	...
	static function checkWebServiceEntry() {
		...
		$sql       =  "SELECT count(id) AS cnt FROM vtiger_ws_entity WHERE name = 'Milestone'";
		...
		if($adb->num_rows($result) > 0)
		{
			...
			if($no == 0)
			{
				...
				$ws_entitySql = "INSERT INTO vtiger_ws_entity ( id, name, handler_path, handler_class, ismodule ) VALUES".
						  " (?, 'Milestone','include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation' , 1)";
