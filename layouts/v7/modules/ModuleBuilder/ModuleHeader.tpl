	...
	<div class="col-sm-12 col-xs-12 module-action-bar clearfix coloredBorderTop">
		<div class="module-action-content clearfix {$MODULE}-module-action-content">
			<div class="col-lg-7 col-md-7 module-breadcrumb module-breadcrumb-{$smarty.request.view} transitionsAllHalfSecond">
				...
				{if $smarty.request.view eq 'MBindex'}
					<p class="current-filter-name filter-name pull-left "><span class="fa fa-angle-right pull-left" aria-hidden="true"></span><a title="">&nbsp;&nbsp;{vtranslate('LBL_CREATE_MODULE', $MODULE)}&nbsp;&nbsp;</a></p>
				{else if $smarty.request.view eq 'Index'}
					<p class="current-filter-name filter-name pull-left "><span class="fa fa-angle-right pull-left" aria-hidden="true"></span><a>&nbsp;&nbsp;{vtranslate('LBL_ADDING_FIELDS', $MODULE)}&nbsp;&nbsp;</a></p>
				{/if}
			...
			<div class="col-lg-5 col-md-5 pull-right">
				...
				{*<!--add and import buttons removed from ui-->*}
